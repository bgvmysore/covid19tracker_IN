...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.deavar.setText(_translate("Form", "TextLabel"))
        self.shead2.setText(_translate("Form", "CURED:"))
        self.curvar.setText(_translate("Form", "TextLabel"))
        self.shead3.setText(_translate("Form", "TOTAL:"))
        self.totvar.setText(_translate("Form", "TextLabel"))
        self.shead.setText(_translate("Form", "ACTIVE:"))
        self.actvar.setText(_translate("Form", "TextLabel"))
